...
var myBST = new BST();
myBST.insert(new BSTNode(155));
myBST.insert(new BSTNode(78));
myBST.insert(new BSTNode(678));
myBST.insert(new BSTNode(43));
myBST.insert(new BSTNode(84));
myBST.insert(new BSTNode(99));
myBST.insert(new BSTNode(900));
